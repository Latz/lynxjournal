	...
	var categoryVariants = [
		{
			...
			links: [
				...
				{
					'[link_title]'      : 'The Best Travel Apps for 2026',
					'[link_url]'        : 'https://traveltech.io/best-apps-2026',
					'[link_description]': 'Tools that make every trip smoother.',
					'[link_domain]'     : 'traveltech.io',
					'[link_date]'       : '2026-06-23',
				},
				{
					'[link_title]'      : 'Solo Travel Safety Tips',
					'[link_url]'        : 'https://safeabroad.com/solo-tips',
					'[link_description]': 'Practical advice for confident solo adventures.',
					'[link_domain]'     : 'safeabroad.com',
		...
		},
		{
			...
			links: [
				...
				{
					'[link_title]'      : 'How to Meal Prep Like a Pro',
					'[link_url]'        : 'https://mealplanner.co/meal-prep-guide',
					'[link_description]': 'Save time and eat better every week.',
					'[link_domain]'     : 'mealplanner.co',
					'[link_date]'       : '2026-06-21',
				},
				{
					'[link_title]'      : "The World's Most Underrated Cuisines",
					'[link_url]'        : 'https://foodexplorer.net/underrated-cuisines',
					'[link_description]': 'Dishes worth seeking out on your next trip.',
					'[link_domain]'     : 'foodexplorer.net',
					'[link_date]'       : '2026-06-20',
				},
			],
		},
		{
			...
			links: [
				...
				{
					'[link_title]'      : '10 National Parks Worth Visiting This Year',
					'[link_url]'        : 'https://parkguide.org/top-parks-2026',
					'[link_description]': 'Stunning landscapes and easy trails for everyone.',
					'[link_domain]'     : 'parkguide.org',
					'[link_date]'       : '2026-06-20',
				},
				{
					'[link_title]'      : 'How Urban Gardens Are Changing Cities',
					'[link_url]'        : 'https://citygreen.io/urban-gardens',
					'[link_description]': 'Green spaces bringing communities together.',
					'[link_domain]'     : 'citygreen.io',
					'[link_date]'       : '2026-06-19',
				},
			],
		},
	];
