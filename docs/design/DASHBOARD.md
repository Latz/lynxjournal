...
The LynxJournal Dashboard provides a beautiful, modern interface for managing your curated link collection with an **editorial aesthetic** inspired by high-end publications.
...
```
LynxJournal/
├── lynxjournal.php          # Main plugin file with dashboard function
...
**Component Classes**
- `.lynxjournal-dashboard` - Main container
...
2. Click "LynxJournal" in the sidebar
