...
- Name: ui/dashboard.spec.js >> LinkDigest dashboard >> stats header is visible
- Location: tests/e2e/ui/dashboard.spec.js:41:9
...
Call log:
  - navigating to "http://localhost:8888/wp-admin/", waiting until "load"
