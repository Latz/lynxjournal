...
describe('LynxJournal::updateTag()', function (): void {
    ...
    it('returns WP_Error passthrough when wp_update_term fails', function (): void {
        ...
        $result = $this->plugin->updateTag($request);
    ...
    it('returns updated term data and invalidates cache on success', function (): void {
        ...
        expect($deletedTransients)->toContain('lynxjournal_api_tags_list');
        expect($deletedTransients)->toContain('lynxjournal_tags_terms');
    });
...
describe('LynxJournal::restCreateTag()', function (): void {
    ...
    it('returns WP_Error passthrough when wp_insert_term fails', function (): void {
        ...
        $result = $this->plugin->restCreateTag($request);
...
describe('LynxJournal::restDeleteTag()', function (): void {
    ...
    it('returns a WP_Error when wp_delete_term returns a WP_Error', function (): void {
        ...
        $result = $this->plugin->restDeleteTag($request);
...
describe('LynxJournal::restGetTagLinkCounts()', function (): void {

    it('wraps getTagLinkCounts() in a REST response', function (): void {
        $this->plugin->shouldReceive('getTagLinkCounts')->once()->andReturn([5 => 3, 7 => 0]);

        $result = $this->plugin->restGetTagLinkCounts();
